...
class ProductsCheckout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Checking if the user total amount is greater than 200 for free delievery, otherwise adding 50 as Delievery charge.
    var finalTotalCost = totalPriceProvider == 0
        ? 0
        : (totalPriceProvider > 200
            ? totalPriceProvider
            : totalPriceProvider + 50);
